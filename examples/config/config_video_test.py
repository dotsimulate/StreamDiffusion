...
def main():
    ...
    script_dir.parent.parent / "configs" / "controlnet_examples" / "multi_controlnet_example.yaml"
    ...
    try:
        process_video(args.config, args.input_video, args.output_dir, engine_only=args.engine_only)
        if args.engine_only:
