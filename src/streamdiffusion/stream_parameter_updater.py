                    ...
                    if old_cache_maxframes != cache_maxframes:
                        for i, cache_tensor in enumerate(self.stream.kvo_cache):
                            ...
                            new_cache_tensor = torch.zeros(
                                new_shape, dtype=cache_tensor.dtype, device=cache_tensor.device
                            )
                        ...
                        logger.info(
                            f"update_stream_params: Cache maxframes updated from {old_cache_maxframes} to {cache_maxframes}, kvo_cache tensors resized"
                        )
                    else:
