...
def compile_unet(
    ...
    amax_save_path = build_options.pop("amax_save_path", None)
    fp8_alpha = build_options.pop("fp8_alpha", 0.8)
    fp8_allow_fp16_fallback = build_options.pop("fp8_allow_fp16_fallback", False)
    # Legacy key removed; silently discard for backward compat with cached callers
    build_options.pop("calibration_data_fn", None)
